...
let s:colors = {
      ...
      \ "white": get(s:overrides, "white", { "gui": "#c8ccd4", "cterm": "145", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#1e222a", "cterm": "235", "cterm16": "0" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#1e222a", "cterm": "59", "cterm16": "15" }),
      \}
